...
<br>
[<img src="https://github.com/RockefellerUniversity/GenomicsData/workflows/compilation-check/badge.svg">](https://github.com/RockefellerUniversity/GenomicsData/actions?query=workflow%3compilation-check)

**The course is tested and available on MacOS, Windows and Ubuntu Linux for `r R.Version()$version.string`**
<br>
[<img src="https://github.com/RockefellerUniversity/GenomicsData/workflows/OS-check/badge.svg">](https://github.com/RockefellerUniversity/GenomicsData/actions?query=workflow%3AOS-check)
